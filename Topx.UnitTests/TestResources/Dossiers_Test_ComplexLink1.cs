...
{
    public class Dossiers_TestComplexLink1
    {
        ...
        public static List<Dossier> GetDossiers()
        {
            ...
            return new List<Dossier>()
            {
                new Dossier()
                {
                    ...
                    ComplexLinks = new List<ComplexLink>(){ new ComplexLink() { ComplexLinkNummer = "1"} }
                },
                new Dossier()
                {
                    Classificatie_Bron = "basisarchiefcode",
                    ...
                    ComplexLinks = new List<ComplexLink>(){ new ComplexLink() { ComplexLinkNummer = "2"} }
                },
                new Dossier()
                {
                    Classificatie_Bron = "basisarchiefcode",
