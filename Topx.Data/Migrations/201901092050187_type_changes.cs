namespace Topx.Data.Migrations
{
    ...
    public partial class type_changes : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Bestand_Formaat_FysiekeIntegriteit_DatumEnTijd = c.DateTime(nullable: false),
                        Bestand_Formaat_DatumAanmaak = c.DateTime(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        IdentificatieArchief = c.String(),
                        DatumArchief = c.DateTime(),
                        OmschrijvingArchief = c.String(),
                        BronArchief = c.String(),
                        DoelArchief = c.String(),
                        NaamArchief = c.String(),
                        LastDossierFileName = c.String(),
                        LastRecordsFileName = c.String(),
                    })
                .PrimaryKey(t => t.Id);
